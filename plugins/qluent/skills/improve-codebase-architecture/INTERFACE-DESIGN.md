...
Include both [LANGUAGE.md](LANGUAGE.md) vocabulary and project-domain
vocabulary in the brief so each sub-agent names things consistently with the
architecture language and the project's own glossary.
